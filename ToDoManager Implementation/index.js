...
app.get('/api/users/:userId/tasks/active', passport.authenticate('jwt', { session: false }), taskController.getActiveTasks); //TODO
app.get('/api/users/:userId/tasks/completed', passport.authenticate('jwt', { session: false }), taskController.getCompletedTasks); // TODO
